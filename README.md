...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dalex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11566&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dalex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dalex` can be installed with:

```
conda install dalex
```

It is possible to list all of the versions of `dalex` available on your platform with:
